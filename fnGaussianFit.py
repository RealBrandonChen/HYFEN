...
Return a Gaussian fit parameter compute FWHM(x,y) using 2D Gaussian fit, min-square optimization
Optimization fits 2D gaussian: center, sigmas, baseline and amplitude
From author: Nikita Vladimirov @nvladimus (2018).
